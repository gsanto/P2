...
import com.example.user.p2.backend.registration.Registration;
...
class GcmRegistrationAsyncTask extends AsyncTask<Context, Void, String> {
    ...
    private static final String SENDER_ID = "264844224408";
    ...
    public GcmRegistrationAsyncTask() {
        ...
        // end of optional local run code 10.0.0.2
        */
        Registration.Builder builder = new Registration.Builder(AndroidHttp.newCompatibleTransport(), new AndroidJsonFactory(), null)
                .setRootUrl("https://neural-aquifer-847.appspot.com/_ah/api/");
